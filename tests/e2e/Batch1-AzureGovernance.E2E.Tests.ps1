...
<#
.SYNOPSIS
    E2E wrapper coverage batch 1 for #745: Azure subscription / management-group
    governance tools.
...
.DESCRIPTION
    ...
    Tools covered: azqr, defender-for-cloud, prowler, finops, azure-cost.
...
.NOTES
    Tracker: docs/audits/e2e-wrapper-coverage-parity.json (E2E-001, E2E-004,
    E2E-005, E2E-007, E2E-009).
#>
...
BeforeDiscovery {
    ...
    $script:Tools = @(
        @{ Name = 'azqr';                Fixture = 'azqr-e2e.json';                ExpectedFindings = 3; Platform = 'Azure' }
        @{ Name = 'defender-for-cloud';  Fixture = 'defender-for-cloud-e2e.json';  ExpectedFindings = 3; Platform = 'Azure' }
        @{ Name = 'prowler';             Fixture = 'prowler-e2e.json';             ExpectedFindings = 3; Platform = 'Azure' }
        @{ Name = 'finops';              Fixture = 'finops-e2e.json';              ExpectedFindings = 3; Platform = 'Azure' }
        @{ Name = 'azure-cost';          Fixture = 'azure-cost-e2e.json';          ExpectedFindings = 3; Platform = 'Azure' }
    )
}
...
$env:AZURE_ANALYZER_SUPPRESS_TOOL_MISSING_WARNINGS = '1'
    ...
    $script:PlantedPat    = 'ghp_FAKEAZURE745E2EBATCH1234567890abcdEF'
...
Describe 'E2E batch 1 (#745): <_.Name>' -ForEach $script:Tools {
