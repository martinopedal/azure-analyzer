...
Describe 'CI failure watchdog watchlist' {
    ...
    It 'covers the critical squad + PR-gate workflows' {
        $required = @('CI', 'CodeQL', 'Docs Check', 'Markdown Check', 'ALZ queries drift check', 'Bicep Build', 'Stub deadline check', 'PR Review Gate', 'PR Advisory Gate', 'Squad Heartbeat (Ralph)', 'PR Auto-Rerun On Push', 'PR Auto-Rebase Conflicts')
