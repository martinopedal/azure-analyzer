...
| `kubescape` | cli ("kubescape") | kubescape/kubescape @ 4.0.13 | `#7b1fa2` | 6 |
...
| `prowler` | cli ("prowler") | prowler-cloud/prowler @ 5.41.0 | `#1f2937` | 4 |
...
| `terraform-iac` | cli ("terraform") | hashicorp/terraform @ 1.16.1 | `#5c4ee5` | 7 |
