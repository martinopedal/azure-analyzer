...
| `prowler` | cli ("prowler") | prowler-cloud/prowler @ 5.38.0 | `#1f2937` | 4 |
...
| `subfinder` | cli ("subfinder") | projectdiscovery/subfinder @ 2.15.0 | `#00695c` | 4 |
| `terraform-iac` | cli ("terraform") | hashicorp/terraform @ 1.15.8 | `#5c4ee5` | 7 |
| `trivy` | cli ("trivy") | aquasecurity/trivy @ 0.73.0 | `#00695c` | 3 |
