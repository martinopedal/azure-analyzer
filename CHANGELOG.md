...
- fix(ci): docs-check now recognizes any file under `docs/` as a valid documentation update for code-changing PRs, preventing false failures when docs are added outside legacy subpaths (for example, `docs/design/`).
