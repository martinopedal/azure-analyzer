...
- **HTML report snippet rendering is now null-safe for Schema 2.2 data**, so findings with partially populated `RemediationSnippets` still render without report-generation failures.
