...
- `Invoke-Pester -Path .\tests\wrappers -Tag 'LiveTool' -CI`: optional live-CLI wrapper smoke tier (gitleaks, trivy, zizmor, scorecard) that exercises real binaries when present, asserts clean success/skip contracts, and fails on unannotated host warning markers (`WARNING:`, `##[warning]`, `Notice:`).
