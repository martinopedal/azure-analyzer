...
- `tests/reports/Collapsible-Tree.Tests.ps1` uses `BeforeAll` fixture generation to keep findings-tree rendering assertions fast as report test coverage expands (PES-003).
