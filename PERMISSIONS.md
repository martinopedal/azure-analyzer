...
|---------|------------------------|
| Azure resources / ARG / Defender / Cost (`alz-queries`, `azqr`, `psrule`, `wara`, `azurecost`, `defender-for-cloud`, `azgovviz`, `finops-toolkit`) | **Reader** on each subscription (or **Management Group Reader** when scoping by MG, deferred — see Out of Scope below) |
