...
> #162 (Roadmap item 4, LA sink) blocks #165 (Roadmap item 7, continuous control). #163 (Roadmap item 5, multi-tenant) also blocks #165. #160 (Roadmap item 2, drift) builds on the PR #150 state layer but is independent of the rest. #159, #161, #164, #166 (Roadmap items 1, 3, 6, 8) are independent and parallelizable.
...
1. **Roadmap item 2 / #160 Drift detection** -- small, high-impact, isolated, unblocks the CISO narrative immediately.
2. **Roadmap item 3 / #161 FinOps signals** -- small, leverages existing cost data, demo-friendly.
3. **Roadmap item 1 / #159 Sentinel posture** -- small/medium, sibling of a freshly-shipped tool, low integration risk.
4. **Roadmap item 8 / #166 ADO Repos + run-logs** -- medium, completes the ADO story the README still calls out.
5. **Roadmap item 6 / #164 Identity graph expansion** -- medium, raises the strategic value of the correlator.
6. **Roadmap item 4 / #162 Log Analytics sink** -- medium/large, prerequisite for #165.
7. **Roadmap item 5 / #163 Multi-tenant fan-out** -- large, prerequisite for #165 at enterprise scale.
8. **Roadmap item 7 / #165 Continuous control mode** -- large, the capstone -- only meaningful once #162 and #163 land.
